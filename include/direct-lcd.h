/*! \file   include/direct-lcd.h
    \brief  control the LCD display directly (Simulator)
...
#ifndef __sim_direct_lcd_h__
#define __sim_direct_lcd_h__
...
// overall memory range: 0xef43-0xef4b (8 bytes)
//
